      ...
      <div className='bg-zinc-800 p-10 shadow-md shadow-black'>
        ...
        <Formik
          ...
          validationSchema = { Yup.object({
            title: Yup.string().required('Título es requerido'), // .min   .max   .email
            description: Yup.string().required('Descripción es requerida'),
            image: Yup.mixed().nullable(true).required("La imagen es requerida") //mixed() indica que se aceptaran todos los tipos y el nullable indica que como la imagen fue marcada como null desde un principio entonces tratara de manejar si es anuable o no mediante los booleanos true y false
          }) }
          ...
          */
          ...
          enableReinitialize
        >
          {/* handleSubmit permite capturar los valores de los campos introducidos en el formulario */}
